export const focusAreas = [
  {
    ...
    whyItMatters:
      'Builds technical confidence, collaboration, and a portfolio that stands out in the job market.',
  },
  {
    id: 2,
    ...
    whyItMatters:
      'Helps women break barriers, access opportunities, and grow into leadership roles.',
  },
  {
    id: 3,
    ...
    whyItMatters: 'Representation inspires the next generation and challenges stereotypes in tech.',
  },
  {
    id: 4,
    ...
    whyItMatters:
      'Fosters belonging, reduces burnout, and reminds women they don’t walk this journey alone.',
  },
];
