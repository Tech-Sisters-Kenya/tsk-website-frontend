...
const navItems = [
  {
    ...
    children: [
      ...
      { href: '/focus-area', label: 'Focus Area' },
      { href: '/impact', label: 'Impact So far' },
    ],
  },
  {
    label: 'Get Involved',
    children: [
      ...
      { href: '/become-tsk-member', label: 'Become a TSK Member' },
    ],
  },
                ...
                {item.children ? (
                  <div className="w-full">
                    ...
                    >
                      ...
                      >
                        {item.label}
                        <span className="text-xl">{activeDropdown === item.label ? '−' : '+'}</span>
                      </div>
                    </div>
                    {activeDropdown === item.label && (
