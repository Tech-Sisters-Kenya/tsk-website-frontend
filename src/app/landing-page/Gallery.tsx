  ...
  return (
    <div className="bg-tsk-light-2 lg:mt-32 w-screen py-12">
      <div className="md:max-w-7xl mx-auto px-6 font-semibold">
        ...
        <p className="text-[#45084a] mx-auto px-10 pb-10 md:px-20 text-center">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <button
            onClick={scrollPrev}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 bg-white rounded-full border-tsk-primary-dark shadow-lg flex items-center justify-center hover:bg-gray-100 transition-all duration-200 -ml-5"
          ...
          <button
            onClick={scrollNext}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-100 transition-all duration-200 -mr-5"
