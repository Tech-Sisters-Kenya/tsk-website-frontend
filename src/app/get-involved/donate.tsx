...
export default function Donate() {
  ...
  return (
    <section className="h-full mb-10">
      <div className="space-y-6 bg-tsk-light-2 px-12 pt-10 lg:pb-56 md:pb-40 pb-20 font-body">
        <div className="bg-tsk-primary-dark grid lg:grid-cols-2 grid-cols-1 place-items-center gap-4 p-8 px-10 rounded-2xl">
          <div className="space-y-4">
            <h4 className="text-tsk-light-2 font-semibold 2xl:text-5xl text-4xl">
              Donate To Our Community
            </h4>
            <p className="text-tsk-light-2 text-[20px] font-semibold lg:w-3/4">
              Your donation empowers the next generation of women in tech. Every contribution helps
              us break barriers, build skills, and create opportunities.
            </p>
          </div>
          <div className="flex justify-center items-center">
            <Image src={donate} alt="donate icon" className="w-full" />
          </div>
        </div>
        ...
        <div className="w-full flex justify-around flex-wrap gap-10 bg-white p-4 xl:pr-28 px-6 rounded-2xl">
          ...
          <form className="flex flex-col justify-center gap-4 font-body">
            <span className="flex justify-between flex-wrap w-full gap-4">
              <input
                type="text"
                placeholder="Name"
                className="bg-tsk-light-2 rounded-[10px] py-3 ps-6 placeholder:text-base placeholder:font-medium placeholder-tsk-primary-dark focus:outline-none sm:w-[45%] w-full"
              />
              <input
                type="email"
                placeholder="Email"
            ...
            <span>
              <input type="radio" name="anonymous" className="accent-tsk-primary-dark text-base" />{' '}
              Anonymous
            </span>
            ...
            <Button className="p-5 w-5/7 my-4 py-4">
              <span className="text-[16px] font-semibold">Submit Donation</span>
            </Button>
          </form>
        </div>
      </div>

      <div className="lg:-top-36 md:-top-24 top-10 flex flex-row justify-center items-center lg:gap-0 gap-4 flex-wrap w-full relative font-semibold md:px-12 sm:px-8 px-5">
        <div className="border-[1px] border-tsk-primary-dark bg-foreground rounded-2xl flex flex-col justify-center pb-20 pt-6 md:px-20 px-14 font-semibold text-[20px] overflow-hidden lg:z-10">
          <h1 className="pb-5 text-center">Contact Us About Your Donation</h1>
          <p className="md:text-center">Are you looking to donate:</p>
          <ul className="list-disc md:place-items-center">
        ...
        <div className="border-[2px] border-tsk-primary-dark text-tsk-primary-dark bg-tsk-light-2 rounded-2xl text-[20px] p-6 px-16 pb-10 lg:z-20 lg:-ml-16 flex flex-col items-center justify-center">
