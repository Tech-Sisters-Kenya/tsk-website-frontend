...
function SponsorSection() {
  return (
    <section className="w-full py-24 px-10 md:px-28 grid grid-cols-1 md:grid-cols-2 md:auto-rows-min gap-8">
      ...
      <div className="w-full justify-self-center max-w-md md:max-w-xl lg:max-w-2xl h-[300px] overflow-hidden md:col-start-1 md:row-start-1 md:row-span-3">
        <svg
