...
export default function TermsAndConditions() {
  return (
    <div className="flex flex-col min-h-screen pb-8 md:pb-16 lg:pb-20 container mx-auto text-tsk-primary-dark">
      ...
      <h2 className="text-[25px] font-bold mt-8">Welcome to Tech Sisters Kenya (TSK)</h2>
      <p>
      ...
      <h2 className="text-[25px] font-bold mt-8">THE PURPOSE OF THE SITE</h2>
      <p>
      ...
      <h2 className="text-[25px] font-bold mt-8">ACCEPTANCE OF TERMS</h2>
      <p>
        By using our website, forms, or joining our programs or Slack community, you agree to these
        Terms and our Privacy Policy, which together govern your relationship with Tech Sisters
        Kenya.
      </p>
      <h2 className="text-[25px] font-bold mt-8">COMMUNITY CONDUCT</h2>
      <p>
      ...
      <h2 className="text-[25px] font-bold mt-8">USER SUBMISSIONS</h2>
      <p>
      ...
      <h2 className="text-[25px] font-bold mt-8">COMMUNICATION</h2>
      <p>
        By providing your contact information, you consent to receive emails or messages related to
        events, mentorship, programs, and opportunities. You may opt out at any time by clicking{' '}
      ...
      <h2 className="text-[25px] font-bold mt-8">INTELLECTUAL PROPERTY</h2>
      <p>
        All content on this site, including logos, graphics, resources, articles, and materials, is
        the property of Tech Sisters Kenya unless otherwise stated. You may not copy, distribute, or
        use our content without prior permission, except for personal, non-commercial use with
        credit.
      </p>
      <h2 className="text-[25px] font-bold mt-8">THIRD-PARTY SERVICES</h2>
      <p>
        Our website or events may reference or integrate third-party platforms (e.g., Google Forms,
        Zoom, Mailchimp). These are governed by their own terms and privacy policies. Tech Sisters
        Kenya is not responsible for any third-party content or practices.
      </p>
      <h2 className="text-[25px] font-bold mt-8">DISCLAIMER</h2>
      <p>
        While we aim to provide accurate and helpful content, we cannot guarantee that all
        information is complete or up to date. Participation in any event, program, or mentorship is{' '}
        <span className="font-semibold">voluntary</span> and at{' '}
      ...
      <h2 className="text-[25px] font-bold mt-8">CHANGES TO THIS TERM</h2>
      <p>
      ...
      <h2 className="text-[25px] font-bold mt-8">TERMINATION</h2>
      <p>
      ...
      <p className="font-semibold">
        ...
        empowering community for women in tech. Let’s continue to build together!
      </p>
    </div>
  );
}
