      ...
      <div className="flex w-full flex-col gap-6 text-tsk-primary-dark max-w-5xl mx-auto">
        <Tabs defaultValue="founding-story">
          <TabsList className="my-10 md:mt-10 md:mb-6 flex flex-col md:flex-row w-full items-stretch justify-center gap-2 md:gap-0">
            <TabsTrigger className="font-medium text-lg lg:text-2xl flex-1" value="founding-story">
              Our Founding Story
            </TabsTrigger>
            <TabsTrigger className="font-medium text-lg lg:text-2xl flex-1" value="focus-areas">
              Our Focus Areas
            </TabsTrigger>
            <TabsTrigger className="font-medium text-lg lg:text-2xl flex-1" value="our-impact">
              Our Impact So Far
            </TabsTrigger>
          </TabsList>
          <TabsContent value="founding-story">
            <Card>
              <CardHeader className="pt-8">
                <CardDescription className="font-medium text-[16px] md:text-[18px] lg:text-[20px]">
          ...
          <TabsContent value="focus-areas">
            <Card>
              <CardHeader className="pt-8">
                <CardDescription className="font-medium text-[16px] md:text-[18px] lgtext-[20px]">
